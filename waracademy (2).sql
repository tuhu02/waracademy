...
CREATE TABLE `pesertaturnamen` (
  ...
  `status` enum('active','eliminated','finished') COLLATE utf8mb4_general_ci DEFAULT 'active',
...
INSERT INTO `pesertaturnamen` (`id_peserta`, `id_turnamen`, `id_pengguna`, `skor_akhir`, `peringkat`, `joined_at`, `status`, `lives_remaining`) VALUES
(1, 1, 1, 0, NULL, '2025-11-08 17:13:10', 'active', 3);
...
('Yp8IolpISpJDW7E6TGXxadNBPFlApCltGAd11e9f', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1762622412);
...
(1, 'Kuis Kemerdekaan', 'MERDEKA', 2, 1, 'Menunggu', NULL, 45, 30, NULL, 500, '2025-11-08 17:13:10', '2025-11-08 17:13:10');
...
CREATE TABLE `turnamen_pertanyaan` (
  ...
  `tingkat_kesulitan` enum('mudah','sedang','sulit') COLLATE utf8mb4_general_ci DEFAULT 'sedang',
...
--
ALTER TABLE `pengguna`
  MODIFY `id_pengguna` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
