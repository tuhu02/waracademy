...
<body class="font-poppins text-white min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-[#1E293B]/60 backdrop-blur-sm border border-slate-700 rounded-2xl w-full max-w-md p-8 shadow-2xl animate-fadeIn">
        ...
        <div class="w-full">
            ...
            <p class="text-slate-400 text-center mb-8">Siap untuk menaklukkan tantangan?</p>
            ...
            <form method="POST" action="{{ route('register.process') }}">
                ...
                <div class="space-y-4">
                    ...
                    <div class="opacity-0 animate-fadeIn delay-400" style="animation-fill-mode: forwards;">
                    ...
                    <div class="opacity-0 animate-fadeIn delay-500" style="animation-fill-mode: forwards;">
                        <label class="block text-sm font-medium mb-2 text-slate-300">Konfirmasi Password</label>
