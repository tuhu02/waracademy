...
--
-- Host: localhost:3306
-- Generation Time: Nov 15, 2025 at 12:03 AM
...
CREATE TABLE `pesertaturnamen` (
  ...
  `status` enum('active','eliminated','finished') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'active',
...
('fdF9hArJZtjVtEJ976euYhzpjb35sZREzcLCJNKD', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1763164151),
('j1yKgympstraJOVaXrbKVnK8snFh9b9TDH1JIjI2', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1763164416),
('Q8n2xtGQdVrCXm1Kt5pDEkXOWy6Ju7I6kqUUumR6', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '', 1763164087),
('uz3RszXkXinIjCQcGJqj2DAG1upDh2pGeVxAXB0p', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiZ1RyUEpCeTJlUnQzTVBLUFpRbFNLS3RKNXhRcHF1Y1IzWGx5MjJnbyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1763160867);
...
CREATE TABLE `turnamen` (
  ...
  `durasi_pengerjaan` int DEFAULT '45',
  `max_peserta` int DEFAULT '30',
  `deskripsi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `bonus_exp` int DEFAULT '500',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `turnamen_jawaban_peserta`
--

CREATE TABLE `turnamen_jawaban_peserta` (
  `id` int NOT NULL,
  `id_peserta` int NOT NULL,
  `id_pertanyaan_turnamen` int NOT NULL,
  `id_jawaban_dipilih` int DEFAULT NULL,
  `waktu_jawab` int DEFAULT NULL,
...
--
-- Table structure for table `turnamen_pertanyaan`
--
...
CREATE TABLE `turnamen_pertanyaan` (
  ...
  `id_turnamen` int NOT NULL,
  `teks_pertanyaan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `poin_per_soal` int DEFAULT '10',
  `waktu_pengerjaan` int DEFAULT '30',
  `tingkat_kesulitan` enum('mudah','sedang','sulit') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'sedang',
  `mata_pelajaran` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `turnamen_pertanyaan`
--
...
--
-- Table structure for table `turnamen_pilihan_jawaban`
--
...
--
-- Dumping data for table `turnamen_pilihan_jawaban`
--
...
--
-- Indexes for table `turnamen_jawaban_peserta`
--
...
--
-- Indexes for table `turnamen_pertanyaan`
--
...
--
-- Indexes for table `turnamen_pilihan_jawaban`
--
...
--
ALTER TABLE `level`
  MODIFY `id_level` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `pertanyaan`
  MODIFY `id_pertanyaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=401;

--
-- AUTO_INCREMENT for table `pesertaturnamen`
--
ALTER TABLE `pesertaturnamen`
  MODIFY `id_peserta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `pilihanjawaban`
--
ALTER TABLE `pilihanjawaban`
  MODIFY `id_jawaban` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2561;
...
--
ALTER TABLE `turnamen`
  MODIFY `id_turnamen` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `turnamen_jawaban_peserta`
--
ALTER TABLE `turnamen_jawaban_peserta`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `turnamen_pertanyaan`
--
ALTER TABLE `turnamen_pertanyaan`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `turnamen_pilihan_jawaban`
--
ALTER TABLE `turnamen_pilihan_jawaban`
  MODIFY `id_jawaban` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
-- Constraints for table `kisi_kisi`
--
ALTER TABLE `kisi_kisi`
...
--
ALTER TABLE `turnamen`
  ADD CONSTRAINT `turnamen_ibfk_1` FOREIGN KEY (`dibuat_oleh`) REFERENCES `pengguna` (`id_pengguna`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `turnamen_jawaban_peserta`
--
ALTER TABLE `turnamen_jawaban_peserta`
